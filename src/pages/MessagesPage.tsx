            ...
            <div className="chat-sidebar__header">
              ...
              <div className="chat-tabs">
                <button
                  ...
                  className={`chat-tab ${activeTab === 'channels' ? 'is-active' : ''}`}
                >
                ...
                <button
                  ...
                  className={`chat-tab ${activeTab === 'notifications' ? 'is-active' : ''} relative`}
                >
                  <FiBell size={16} />
                ...
                <div className="h-full flex flex-col">
                  ...
                  <div className="p-4 border-b border-gray-200 dark:border-gray-700 space-y-3">
                    ...
                    <button
                      ...
                      className="btn-emerald w-full flex items-center justify-center space-x-2"
